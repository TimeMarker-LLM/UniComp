...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def __init__(self, config: Qwen2Config):
        ...
        self.post_init()
        # fastvid_retention_ratio=0.05
        # fastvid_DySeg_c=8
        # fastvid_DySeg_tau=0.9
        # fastvid_STPrune_d=0.4
        # fastvid_DTM_p=4
        # fastvid_DTM_alpha=0.6
        import os
        self.fastvid_retention_ratio = float(os.environ.get("RETAIN_RATIO", 0.2))
        self.fastvid_DySeg_c = int(os.environ.get("fastvid_DySeg_c", 8))
        self.fastvid_DySeg_tau = float(os.environ.get("fastvid_DySeg_tau", 0.9))
        self.fastvid_STPrune_d = float(os.environ.get("fastvid_STPrune_d", 0.4))
        self.fastvid_DTM_p = int(os.environ.get("fastvid_DTM_p", 4))
        self.fastvid_DTM_alpha = float(os.environ.get("fastvid_DTM_alpha", 0.6))
        
       
        print(f'attn_implementation={self._attn_implementation} fastvid_retention_ratio={self.fastvid_retention_ratio} fastvid_DySeg_c={self.fastvid_DySeg_c} fastvid_DySeg_tau={self.fastvid_DySeg_tau} fastvid_STPrune_d={self.fastvid_STPrune_d} fastvid_DTM_p={self.fastvid_DTM_p}  fastvid_DTM_alpha={self.fastvid_DTM_alpha}')
    ...
    def forward(
        ...
        if seq_length > 1:
            ...
            salient_indexes = salient_indexes.to(all_indices_mask.device) 
